...
export const SocialLinks: React.FC = () => {
    return (
        <div className="columns social-links is-mobile">
            ...
            <SocialLink title="Draugiem" url="/"><DraugiemIcon /></SocialLink>
        </div>
    )
}
...
const SocialLink: React.FC<SocialLinkProps> = ({ title, url, children }) => (
    <div className="column has-text-centered">
        <a className="social-icon" href={url} rel="noopener noreferrer" target="_blank" title={title}>
            <span className="icon">
                {children}
            </span>
        </a>
